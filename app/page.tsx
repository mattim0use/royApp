...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      >
        <Image className="fixed" fill src="/wallBackground.png" alt="bg" />

        <div className="fixed -top-24 left-1/4 -ml-4 mb-6 flex flex-col items-center flex-grow pt-10 text-green-500 font-pixellify">
          <div className="absolute top-80 left-40  backdrop-blur-lg rounded-full">
            <Image
              className="fixed"
              fill
              src={roy.attributes?.image || "/RoyTitleScreen.png"}
            ...
            <div className="relative overflow-auto w-[550px] h-[450px] bg-gradient-to-b from-transparent to-gray-900 opacity-95 backdrop-blur-lg p-12 rounded-badge">
              <RoyInterface />
            </div>
          </div>
